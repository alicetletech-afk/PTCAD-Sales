              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 24px;background:linear-gradient(135deg,#fffaf0,#fff3d7);border:1px solid #f0d79c;border-radius:16px;">
                <tr>
                  <td style="padding:18px 20px 17px;">
                    <div style="display:inline-block;padding:5px 10px;border-radius:999px;background:#ffe6a7;color:#7a5510;font-size:12px;font-weight:700;letter-spacing:.08em;">
                      RENEWAL REMINDER
                    </div>

                    <div style="margin-top:12px;font-size:21px;line-height:1.35;font-weight:700;color:#6d4a00;">
                      แจ้งเตือนการต่ออายุ License
                    </div>

                    <div style="margin-top:6px;font-size:16px;line-height:1.5;color:#8a6419;">
                      เหลืออีกประมาณ <strong>30 วัน</strong>
                    </div>

                    <div style="margin-top:8px;font-size:14px;line-height:1.75;color:#6f5b34;">
