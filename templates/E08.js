...
window.PTCAD_TEMPLATES.push({
  ...
  render(values) {
    ...
    const ctaBlock = (renewalButton || lineButton)
      ? `<div style="text-align:center;margin:26px 0 8px;">${renewalButton}${lineButton}</div>`
      : "";
    ...
    const attachmentBlock = values.AttachQuotation
      ? `<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:20px 0;background:#fbfdff;border:1px solid #e2edf8;border-radius:12px;">
          <tr>
            <td style="padding:14px 16px;font-size:15px;color:#30445f;">
...
<head>
  ...
  <title>PTCAD Renewal Reminder</title>
</head>
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:680px;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 16px 45px rgba(36,72,121,.12);">
          ...
          <tr>
            <td style="padding:34px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 24px;background:#fff8e8;border:1px solid #f2daa0;border-radius:14px;">
                <tr>
                  <td style="padding:20px;text-align:center;">
                    <div style="width:44px;height:44px;border-radius:50%;background:#f2a51a;color:#ffffff;line-height:44px;text-align:center;font-size:21px;font-weight:700;margin:0 auto 10px;">30</div>
                    <div style="font-size:21px;font-weight:700;color:#805b13;">License จะหมดอายุในอีก 30 วัน</div>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:22px 0;background:#f8fbff;border:1px solid #dce9f7;border-radius:14px;">
                ...
                <tr>
                  ...
                  <td align="right" style="padding:13px 18px;border-top:1px solid #e2edf8;font-size:15px;color:#b36b00;"><strong>${v.ExpireDate}</strong></td>
                </tr>
              </table>
              ...
              <p style="margin:0 0 18px;font-size:17px;line-height:1.85;">
                ...
                ทีมงานสามารถช่วยตรวจสอบรายละเอียดและจัดเตรียมใบเสนอราคาต่ออายุให้ได้
              </p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:24px 0 20px;background:#eef6ff;border-left:4px solid #2d66d5;border-radius:12px;">
                <tr>
                  <td style="padding:18px 20px;">
                    <div style="font-size:17px;font-weight:700;color:#17449f;margin-bottom:7px;">ต่ออายุก่อนหมดอายุ</div>
                    <div style="font-size:15px;line-height:1.75;color:#3f5674;">
                      ช่วยลดความเสี่ยงในการหยุดใช้งาน และทำให้ทีมงานมีเวลาเพียงพอในการตรวจสอบและดำเนินการต่ออายุ License
                    </div>
                  </td>
                </tr>
              </table>
