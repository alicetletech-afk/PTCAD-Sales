...
<head>
  ...
  <title>PTCAD Renewal Reminder 7 Days</title>
</head>
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:680px;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 16px 45px rgba(36,72,121,.12);">
          ...
          <tr>
            <td style="padding:34px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 24px;background:linear-gradient(135deg,#fff6f3,#ffe8e1);border:1px solid #efb7a9;border-radius:16px;">
                <tr>
                  <td style="padding:24px 24px 22px;">
                    <div style="display:inline-block;padding:6px 12px;border-radius:999px;background:#f06a4a;color:#ffffff;font-size:12px;font-weight:700;letter-spacing:.08em;">
                      URGENT REMINDER
                    </div>

                    <div style="margin-top:16px;font-size:23px;line-height:1.35;font-weight:700;color:#9f3c25;">
                      License จะหมดอายุภายใน 7 วัน
                    </div>

                    <div style="margin-top:8px;font-size:17px;line-height:1.5;color:#b55b43;">
                      กรุณาดำเนินการต่ออายุโดยเร็ว
                    </div>

                    <div style="margin-top:12px;font-size:15px;line-height:1.75;color:#6e5148;">
                      เพื่อหลีกเลี่ยงการใช้งานสะดุด แนะนำให้ดำเนินการต่ออายุก่อนวันหมดอายุ
                    </div>
                  </td>
                </tr>
              </table>
              ...
              <p style="margin:0 0 18px;font-size:17px;line-height:1.85;">
                ...
                ของ <strong>${v.CompanyName}</strong> กำลังจะหมดอายุภายใน 7 วันค่ะ
              </p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:22px 0;background:#f8fbff;border:1px solid #dce9f7;border-radius:14px;">
                ...
                <tr>
                  ...
                  <td align="right" style="padding:13px 18px;border-top:1px solid #e2edf8;font-size:15px;color:#b34a2f;"><strong>${v.ExpireDate}</strong></td>
                </tr>
              </table>

              <p style="margin:0 0 18px;font-size:17px;line-height:1.85;">
                เพื่อให้สามารถใช้งานโปรแกรมได้อย่างต่อเนื่อง
                รบกวนดำเนินการต่ออายุก่อนวันหมดอายุค่ะ
                ทีมงานสามารถช่วยตรวจสอบข้อมูลและจัดเตรียมใบเสนอราคาต่ออายุให้ได้ทันที
              </p>

              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:22px 0;background:#fff8f5;border-left:4px solid #f06a4a;border-radius:12px;">
                <tr>
                  <td style="padding:18px 20px;">
                    <div style="font-size:17px;font-weight:700;color:#9f3c25;margin-bottom:7px;">แนะนำให้ดำเนินการภายใน 7 วัน</div>
                    <div style="font-size:15px;line-height:1.75;color:#694f48;">
                      เพื่อให้มีเวลาเพียงพอสำหรับการตรวจสอบข้อมูลและดำเนินการต่ออายุ License
                      ก่อนวันหมดอายุ
                    </div>
                  </td>
                </tr>
