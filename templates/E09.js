              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 24px;background:linear-gradient(135deg,#fff6f3,#ffe8e1);border:1px solid #efb7a9;border-radius:16px;">
                <tr>
                  <td style="padding:18px 20px 17px;">
                    <div style="display:inline-block;padding:5px 10px;border-radius:999px;background:#f06a4a;color:#ffffff;font-size:12px;font-weight:700;letter-spacing:.08em;">
                      URGENT REMINDER
                    </div>

                    <div style="margin-top:12px;font-size:21px;line-height:1.35;font-weight:700;color:#9f3c25;">
                      License จะหมดอายุภายใน 7 วัน
                    </div>

                    <div style="margin-top:6px;font-size:16px;line-height:1.5;color:#b55b43;">
                      กรุณาดำเนินการต่ออายุโดยเร็ว
                    </div>

                    <div style="margin-top:8px;font-size:14px;line-height:1.75;color:#6e5148;">
